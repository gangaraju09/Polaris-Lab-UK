(function(){
    ...
    var arrayObj = [{data:"std_dev_age", text:"Standard Deviation of Age "}, {data:"native_share", text:"Native Share"}, {data:"education_variability", text:"Education Variability"}, {data:"region_name", text:"Region name"}, {data:"job_variability", text:"Job Variability"}, {data:"frac_employed", text:"Fraction Employed"}, {data:"median_income", text:"Medium Income"}, {data:"gini_index", text:"Gini Index"}, {data:"Lindqvist_Ostling_S1", text:"Lindqvist Ostling A"}, {data:"Abramowitz_Saunders_S1", text:"Abramowitz Saunders A"}, {data:"Duca_Saving_S1", text:"Duca Saving A"}, {data:"Lindqvist_Ostling_S2", text:"Lindqvist Ostling B"}, {data:"Abramowitz_Saunders_S2", text:"Abramowitz Saunders B"}, {data:"Duca_Saving_S2", text:"Duca Saving B"}, {data:"Lindqvist_Ostling_S3", text:"Lindqvist Ostling C"}, {data:"Abramowitz_Saunders_S3", text:"Abramowitz Saunders C"}, {data:"Duca_Saving_S3", text:"Duca Saving C"}];
